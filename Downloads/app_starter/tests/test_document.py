...
class TestBinaryDocumentToMarkdown:
    ...
    def test_document_path_to_markdown_file_not_found(self) -> None:
        """Test that FileNotFoundError is raised for nonexistent file."""
        with pytest.raises(FileNotFoundError):
            document_path_to_markdown("/nonexistent/path/document.pdf")

    def test_document_path_to_markdown_no_extension(self) -> None:
